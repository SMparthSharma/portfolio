                          ...
                          children: [
                            Padding(
                              ...
                              child: SizedBox(height: 25,
                                child: IconButton(onPressed: (){print("Edit");}, icon: Icon(Icons.edit_note,color: Colors.amber,)),
                              ),
                            ),

                            Expanded(
                              child: AutoSizeText("Parth sharma", style: GoogleFonts.roboto(
